fetch("https://sabdaliterasi.xyz/api/convert/sisyphus", {
  ...
  el.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 500, fill: "forwards" });
    ...
    AI_SB.innerHTML=`<button  id="AI_SB_toggle"> <img src="https://sabdaliterasi.xyz/api/convert/img/ckeditor/1740615550803_CS.webp?width=190" alt="Chat Toggle" id="AI_SB_toggle_img"> </button> <div id="AI_SB_chatContainer" style="display:none;"> <div id="AI_SB_chatBox"> <div id="AI_SB_open"> <h3>Halo, Comrade!</h3> <p>Silahkan mulai percakapan kamu bersama Sisyphus.</p> </div> </div> <div id="AI_SB_inputContainer"> <input type="text" id="AI_SB_userMessageInput" placeholder="Ketik pesan..." autocomplete="off"> <button id="AI_SB_sendButton">Kirim</button> </div> </div>`
  fadeIn(AI_SB)
